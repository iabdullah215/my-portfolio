...
description: "A network forensics writeup from AirTech CTF 2024 — spotting the flag smuggled one byte at a time inside the SYN packets of the TCP handshake."
date: "2024-03-2"
