...
description: "A pwn writeup from CSAW CTF 2024 — leaking an address through a format-string bug to defeat PIE and ASLR, then redirecting execution to the win function."
date: "2024-09-20"
