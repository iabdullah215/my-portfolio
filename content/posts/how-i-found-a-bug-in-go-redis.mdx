---
title: "How I Found and Fixed a Panic Bug in go-redis by Fuzzing the RESP3 Parser"
description: "A first-timer's walkthrough of fuzzing the RESP3 reply parser in go-redis — from a five-second crash to disclosure with Redis's security team and a four-line fix merged into a library with millions of downloads."
date: "2026-07-10"
